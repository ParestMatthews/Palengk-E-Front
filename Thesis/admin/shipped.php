...
include 'includes/sidebar.php';
  $transq = "SELECT * FROM transactions WHERE Transaction_shipped = 1 ORDER BY Transaction_date DESC";
...
<div class="col-md-12">
        <div class="card">
                  <div class="card-header text-center text-success"><i class="glyphicon glyphicon-folder-open"></i> Shipped Orders</div>
                      <div class="card-body">
  <legend>Orders to Complete</legend>
  <?php if(mysqli_num_rows($transresult) == 0): ?>
    <div class="bg-danger cartemp" style="height:100px;">
        ...
        There are no Orders to complete yet
      </p>
    </div>
  <?php else: ?>
  <table class="table table-striped">
    ...
    <tbody>
      <?php while($order = mysqli_fetch_assoc($transresult)): ?>
        <tr>
            <td><a href="shippedorders.php?trans_id=<?=$order['Transaction_id']?>" class="btn btn-xs btn-success">Details</td>
