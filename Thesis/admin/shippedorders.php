<?php
  ...
  $productq = $db->query(
    ...
    if (isset($_GET['complete']) && $_GET['complete'] == 1){
      $db -> query("UPDATE transactions SET Transaction_shipped = 2, Transaction_paid = 1 WHERE Transaction_id = '{$trans_id}'");
...
<div class="col-md-12">
        <div class="card">
          <div class="card-header text-center text-success">Items Ordered <?=(($trans['Transaction_paid'] == 0)?'<span class="text-danger">(Not Paid)</span>':'<span class="text-success">(Paid)</span>');?></div>
  <div class="card-body">
...
<div class="text-right">
  <a href="shipped.php" class="btn btn-large btn-danger">Cancel</a>
  <a href="shippedorders.php?complete=1&trans_id=<?=$trans_id?>" class="btn btn-success btn-large">Complete Order</a>
</div>
</div>
</div>
</div>
